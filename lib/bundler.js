...
module.exports = function(arg) {
    ...
    if (typeof arg === 'string') {
        ...
        // multi source stuff
        if (!name) {
            throw new Error('bundle name required');
        }

        bundle.require(name, arg.src);
    }
    ...
    // automatically require module on script load
    if (auto_load) {
        bundle.append('require(\'' + name + '\');');
    }
